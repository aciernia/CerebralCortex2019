...
regions <- readPeakFile("/share/lasallelab/Annie/NDD_DMR_12_6_18/ROIsmoothed/promoters_mod.bed", as = "data.frame")
...
getSmooth(bsseq = bs.filtered.bsseq,
          regions = regions,
          out = "/share/lasallelab/Annie/NDD_DMR_12_6_18/ROIsmoothed/ASD_promoter_smoothed_methylation.txt")
...
getSmooth(bsseq = bs.filtered.bsseq,
          regions = regions,
          out = "/share/lasallelab/Annie/NDD_DMR_12_6_18/ROIsmoothed/RTT_promoter_smoothed_methylation.txt")
rm(bs.filtered.bsseq)
...
getSmooth(bsseq = bs.filtered.bsseq,
          regions = regions,
          out = "/share/lasallelab/Annie/NDD_DMR_12_6_18/ROIsmoothed/Dup15q_promoter_smoothed_methylation.txt")
